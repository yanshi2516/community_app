...
class AdminPostsWidget extends StatefulWidget {
  const AdminPostsWidget({Key? key}) : super(key: key);

  @override
  State<AdminPostsWidget> createState() => _AdminPostsWidgetState();
}

class _AdminPostsWidgetState extends BaseStatefulWidgetState<AdminPostsWidget> {
  @override
  Widget buildBody() {
